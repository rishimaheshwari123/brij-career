    ...
    <div className="min-h-screen bg-gray-50 py-16 px-6">
      ...
      <div className="text-center">
        ...
        <p className="text-lg text-gray-700 max-w-3xl mx-auto flex items-center justify-center mt-4">
          <FaGlobe className="text-[#040232] mr-2 text-xl" />
      ...
      <div className="mt-10 text-center max-w-4xl mx-auto text-gray-800 text-lg leading-relaxed">
        <p>
          Brij International Services is a premier recruitment agency in India, dedicated to ethically outsourcing talented professionals worldwide. 
          For over 8 years, we have been connecting businesses with skilled individuals, ensuring the right person for the right job.
        </p>
        <p className="mt-4">
          Our commitment to ethical hiring and a meticulous recruitment process makes us a trusted partner for global businesses. 
          We align with our clients and candidates, eliminating unethical procedures and ensuring a seamless recruitment experience.
        </p>
      </div>
    ...
    {[
      ...
      <div className="mt-20">
        ...
        <div className="mt-10 grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {[  
            {
              location: "Mumbai, India",
              address: "Office 510, B Wing, Galleria Complex, Hiranandani Gardens, Powai, Mumbai 400076",
            },
            {
              location: "Bhopal, India",
              address: "404, Wing B4, Katara Hills, Bhopal (MP) - India, 462002",
            },
            {
              location: "Dubai, UAE",
            ...
            <div key={index} className="bg-white shadow-lg p-6 rounded-lg border-l-4 border-[#040232] transform hover:scale-105 transition duration-300">
              <h3 className="text-xl font-semibold text-gray-800 flex items-center">
                <FaMapMarkerAlt className="text-[#040232] mr-2" /> {office.location}
              </h3>
      ...
      <div className="mt-20 text-center">
        <p className="text-lg font-semibold text-gray-800 bg-blue-100 p-4 rounded-lg shadow-md inline-block">
          🚀 We specialize in ethical and transparent global recruitment services.
        </p>
      </div>
    </div>
  );
